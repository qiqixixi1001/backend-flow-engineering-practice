...
Backend implementation is a multi-format discipline. LEF, Liberty, Verilog, DEF, SDC, SDF, SPEF, GDS, and related formats describe different views of the same design. None of them is sufficient alone. A backend tool becomes useful when it can align these views into one internal database.
