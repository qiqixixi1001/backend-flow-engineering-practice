# 12. Collection, Property, and Filter: Why Object Querying Defines the Upper Bound of Backend Script Engineering
...
```text
write queries before fixes; avoid text scraping; preserve object type; make filters explicit and testable
```
...
> Are scripts acting on intended objects or only on matching text patterns?
